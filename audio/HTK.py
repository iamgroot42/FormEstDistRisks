# Source https://github.com/danijel3/PyHTK/blob/master/python/HTK.py
...
def HCopy(conf, wav, htk):
    ...
    output = None
    try:
        output = subprocess.check_output(["HCopy", "-C", conf,
                                         "-T", "1", wav, htk])
...
class HTKFile:
    """ Class to load binary HTK file.
        ...
        Not everything is implemented 100%, but most features
            should be supported.
        Not implemented:
            CRC checking - files can have CRC, but it won't be
    ...
    def load(self, filename, warning=False):
        """ Loads HTK file.
        ...
        with open(filename, "rb") as f:
            ...
            if "K" in self.qualifiers and warning:
