# Source: https://github.com/kevobt/speech-to-text-voxforge
...
def download_and_extract(url: str,
    ...
    :param items_count: total amount of items to download.
        Displayed for logging
    """
...
def download_corpus(target_directory: str,
                    ...
                    voxforge_url="http://www.repository.voxforge1.org/"
                                 "downloads/SpeechCorpus/Trunk"
                                 "/Audio/MFCC/16kHz_16bit/MFCC_0_D"):
    """
    Initiates download of the voxforge speech corpus
    :param target_directory: target directory for the files
    :param max_workers: amount of threads to be used for
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Downloader for voxforge")
    parser.add_argument('directory', help='directory to store corpus')
    parser.add_argument('-n', '--number', type=int, help="m.o. files")
    parser.add_argument('-w', '--workers', type=int, help="n.o. threads")
