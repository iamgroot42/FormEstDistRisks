...
ds = CIFAR()
ds_sample = CIFAR()
ds_robust = RobustCIFAR("./datasets/cifar_dr_l1")

model_kwargs = {
	'arch': 'resnet50',
	'dataset': ds,
	'resume_path': './models/cifar_l1_10.pt'
}
...
train_loader_sample, _ = ds_sample.make_loaders(workers=10, batch_size=128, data_aug=False)
