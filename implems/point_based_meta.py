...
if __name__ == "__main__":
	...
	folders = ["/u/as9rw/work/fnb/implems/celeba_models/smile_old_vggface_cropped_augs/",
	...
	_, dataloader = ds.make_loaders(batch_size=100, workers=8, shuffle_val=True, only_val=True)
