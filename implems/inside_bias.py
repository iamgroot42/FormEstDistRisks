...
if __name__ == "__main__":
    ...
    parser.add_argument('--sample', type=int, default=2500, help='number of query points per label-property to use for calculations')
    parser.add_argument('--layer', type=int, default=6, help="which layer's activations to look at")
