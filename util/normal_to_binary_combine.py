import torch as ch
from robustness.datasets import GenericBinary, CIFAR, RobustCIFAR
...
ds = RobustCIFAR("/p/adversarialml/as9rw/datasets/cifar10_split2")
dest_path = "/p/adversarialml/as9rw/datasets/new_exp/small/" + name
ds_binary = GenericBinary(dest_path)

# Make main folder, train, test folders
os.mkdir(dest_path)
...
class_names = ['animal', 'vehicle', 'animal', 'animal', 'animal', 'animal', 'animal', 'vehicle', 'vehicle', 'vehicle']
